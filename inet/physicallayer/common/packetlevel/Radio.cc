...
{
    EV << "Radio checking if listening is possible: ";
...
void Radio::updateTransceiverState()
{
    ...
    EV << "newRadioReceptionState - " << newRadioReceptionState << endl;
